<?php
    ...
    if(isset($_GET['offset']) && isset($_GET['limit'])) {
        ...
        $data = mysqli_query($con,"SELECT * FROM trainings_tbl LEFT JOIN trainingtype_tbl ON trainingtype_tbl.id=trainings_tbl.TypeId WHERE trainings_tbl.TypeId= 2 ORDER BY trainings_tbl.id ASC LIMIT {$limit} OFFSET {$offset}");
